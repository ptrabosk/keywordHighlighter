...
const caughtOverridesByRuleId = {
  ...
  rule_d2cb7cc4fe8a0d76: 'Send this text to subscribe to periodic auto texts for Acme (ref: abc123)',
  ...
  rule_7b9e2986edf50834: 'End all communication.',
  rule_9ae98939ff042262: 'Take my number off.',
